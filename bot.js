var HTTPS = require('https');
	...
	function respond() {
	  ...
	  if(request.text && botRegex.test(request.text)) {
	    ...
	    this.res.writeHead(200);
	    postMessage("https://pbs.twimg.com/media/CLGaDFcWUAEGYtJ.jpg");
	    this.res.end();
	  } 
	    ...
	    this.res.writeHead(200);
	    postMessage("http://i3.kym-cdn.com/entries/icons/original/000/022/022/C2AAMCLVQAESU6Z.jpg");
	    this.res.end();
	  } 
	    ...
	    this.res.writeHead(200);
	    postMessage("http://2.bp.blogspot.com/-Y_ODcECzxGQ/T4sMKffGa8I/AAAAAAAAA88/LnQ8Dvynqbg/s1600/michael-scott-no.gif");
	    this.res.end();
	  } 
